            ...
            [
                [
                    InlineKeyboardButton(
                        "Developer", url="https://t.me/IshanAvasthi"
                    ),
                    InlineKeyboardButton("Project Channel", url="https://t.me/IshanUpdates"),
                ],
                [InlineKeyboardButton("My Website", url="https://avasthi-git.github.io")],
            ]
        ),
    )
